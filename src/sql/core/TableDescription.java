...
public class TableDescription
{
	...
	/**
	 * The method resolves an array of columns into the actual column headings
	 * to be returned (i.e. * is resolved to all the column names). If an invalid
	 * column name is given, then it will throw an SQLException.
	 */
